...
Before setting out on this perilous journey, I write a Hippocratic oath which I believe all developers of computational tools should swear by before haphazardly developing and publishing new software tools.
...
\begin{figure}[htb!]
	...
	\begin{tcolorbox}
		\begin{itemize}
			...
			\item I will report positive achievements of my method, but also be critical of it, and discuss areas in which it performs sub-optimally
