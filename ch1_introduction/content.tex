...
% KDP: niet alleen TFs maar volledige epigenetica regelt of een gen al dan niet tot expressie wordt gebracht, dus misschien kort vermelden dat het toch iets complexer is
...
While modern implementations of IHC improve the throughput drastically by using robots to automate the image acquisition and computer software to automate cell segmentation, the procedure is still labour intensive as the robots and computer software still needs to be kept in check.
...
% KDP: circumvents segmentation: if you want to investigate tissues you have to dissociate the tissue 
...
% KDP: vermeld hier hoeveel merkers flow cytometrie tegenwoordig aankan, want je komt er later op terug
