...
\title{Self-assessment in trajectory inference}
...
\author[\afdambi,\afappmat,*]{Yvan~Saeys}
...
\affil[*]{{\footnotesize Corresponding author, \href{mailto:yvan.saeys@ugent.be}{yvan.saeys@ugent.be}}}
\date{}
%\author{Robrecht Cannoodt et al.}
