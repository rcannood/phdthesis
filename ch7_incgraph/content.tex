...
%% FIGURE 2
\picfig{fig/figure2.pdf}{.7\linewidth}{fig_efficient}{{\bf Several strategies are employed in order to reduce time and memory consumption.}
...
%% FIGURE 4
\picfig{fig/figure4.pdf}{.9\linewidth}{fig_method_reranking}{{\bf Predicted gene regulatory networks of model organisms are optimised to reduce the false positive rate.}
