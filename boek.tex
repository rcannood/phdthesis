...
% if switching for quick renders
\newif\ifrenderall
...
{\large \textbf{Abstract}}
\begin{quote}
	\textbf{Purpose:} A brief of 75 articles of trajectory tools reveals 
	that only 37\% of works contain a quantitative self-assessment. 
	While self-assessments are universally biased in favour of the
	authors, it is dangerous to publish a computational tool
	without quantitatively demonstrating its performance compared to
	state-of-the-art methods. \\
	\textbf{Results:} We hypothesise that low self-assessment rates are
	primarily caused by a lack of a standardised problem definition, readily
	available benchmarking datasets, and suitable metrics. We elaborate on
	these causal reasons and provide viable solutions for 
	performing benchmarks more easily.\\
	\textbf{Conclusion:} With this perspective, we hope to address the
	elephant in the room, and provide 
	developers of trajectory inference methods with the necessary 
	tools for performing benchmarking software quantitatively. 
\end{quote}
...
\begin{quote}
	...
	\textbf{Results:}  Here, we summarise key practical guidelines and recommendations for performing high-quality benchmarking analyses, based on our experiences in computational biology. Our review spans the full pipeline of benchmarking, from defining the scope to best practices for reproducibility. This includes crucial questions regarding design and evaluation principles. \\
	\textbf{Conclusion:} With this review, we aim to guide computational researchers in avoiding common pitfalls in designing, performing, and interpreting benchmarks.
\end{quote}

\vfill
{\large \textbf{Publication status}}
\begin{quote}
  Published in Genome Biology 20, 125 (2019). \doi{10.1186/s13059-019-1738-8}. \\
...
{\large \textbf{Author contributions}}
\begin{quote}
	$\bullet$ L.M.W. proposed the project and drafted the manuscript.\\
	$\bullet$ W.S., \textbf{R.C.}, C.S., A.H., P.P.G., A.L.B., Y.S., and M.D.R. contributed ideas and references and contributed to drafting of the manuscript.\\
	$\bullet$ Y.S. and M.D.R. supervised the project.
\end{quote}
