...
\usepackage{makecell}
\newcommand{\doackl}{%
	\textcolor{med-gray}{\footnotesize\makecell[l]{\hspace*{-1.06em}\partialinput{\theacki}{\theacki}{ack}}}%
	\stepcounter{acki}%
}
\newcommand{\doackr}{%
\textcolor{med-gray}{\footnotesize\makecell[r]{\partialinput{\theacki}{\theacki}{ack}}}%
\stepcounter{acki}%
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage{\thispagestyle{empty}\cleardoublepage}
\chapter{incgraph: Optimising regulatory\\networks} 
