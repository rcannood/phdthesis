...
\begin{quote}
	...
	$\bullet$ S.T. and D.S. generated experimental data.\\
	$\bullet$ \textbf{R.C.} implemented the SCORPIUS software package.\\
	$\bullet$ \textbf{R.C.} wrote the original manuscript.\\
	$\bullet$ \textbf{R.C.}, S.J., M.G., B.L., K.D.P., and Y.S. reviewed and edited the manuscript. \\
...
\begin{quote}
	...
	\textbf{Results:} IncGraph calculates the differences in graphlet counts with respect to the network in its previous state.
...
\ifrenderall
\newpage
\graphicspath{{./ch8_selfassessment/}}
\include{ch8_selfassessment/content}
\clearpage
\section{References}
\printbibliography[heading=none]
\fi 
...
\begin{quote}
  Published in Genome Biology 20, 125 (2019). \doi{10.1186/s13059-019-1738-8}. \\
	Weber LM, Saelens W, \textbf{Cannoodt R}, Soneson C, Hapfelmeier A, Gardner PP, Boulesteix AL, Saeys Y, and Robinson MD 
\end{quote}
...
\ifrenderall
\newpage
\graphicspath{{./ch9_guidelines/}}
\include{ch9_guidelines/content}
\fi
...
\ifrenderall
\newpage
\graphicspath{{./ch10_discussion/}}
\include{ch10_discussion/content}
\fi 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%        BACKMATTER         %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
