...
%	\else% uncomment this else to get odd/even instead of even/odd
	...
	{%
		\begin{figure}[tbh!]
			\centering\includegraphics[height=.75\textheight]{fig/figure_2.pdf}
			\caption{
...
We generated a panel of toy datasets (using our \href{https://github.com/dynverse/dyntoy}{\textit{dyntoy}} package, \url{https://github.com/dynverse/dyntoy}) with all possible combinations of:
