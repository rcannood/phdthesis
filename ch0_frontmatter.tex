...
\newcommand{\orcid}[1]{	\includegraphics[width=3mm]{fig/icons/orcid.png}\;\href{https://orcid.org/#1}{{https://orcid.org/}{\color{black}#1}}}
\newcommand{\github}[1]{	\includegraphics[width=3mm]{fig/icons/github.png}\;\href{https://github.com/#1}{{https://github.com/}{\color{black}#1}}}
...
\begin{flushright}
	...
	because you never fail to put a smile on my face.
\end{flushright}
\vfill\ 
%%%%%%%%%%%%%
%%% LISTS %%%
