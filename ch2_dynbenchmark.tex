...
\begin{figure}
	\centering\includegraphics[width=\linewidth]{fig/dynbenchmark/figure_1.pdf}
	\caption{
...
\begin{figure}
	\centering\includegraphics[width=\linewidth]{fig/dynbenchmark/supfigure_1.pdf}
	\caption{
...
\begin{figure}
	...
	Figure caption on next page $\rightarrow$
\end{figure}
...
\begin{figure}
	\centering\includegraphics[width=\linewidth]{fig/dynbenchmark/supfigure_3.pdf}
	Figure caption on next page $\rightarrow$
\end{figure}
...
\begin{table}
	...
	\begin{tabular}{p{2.5cm}p{7.5cm}p{3cm}}
		\toprule
...
\begin{figure}
	\centering\includegraphics[width=\linewidth]{fig/dynbenchmark/figure_5.pdf}
	\caption{
...
\begin{figure}
	\centering\includegraphics[width=\linewidth]{fig/dynbenchmark/figure_6.pdf}
	\caption{
...
The dyngen (\href{https://github.com/dynverse/dyngen}{https://github.com/dynverse/dyngen}) workflow to generate synthetic data is based on the well established workflow used in the evaluation of network inference methods \cite{schaffter_genenetweaversilicobenchmark_2011,marbach_wisdom_2012} and consists of four main steps: network generation, simulation, gold standard extraction and simulation of the scRNA-seq experiment. At every step, we tried to mirror real regulatory networks, while keeping the model simple and easily extendable. We simulated a total of 110 datasets, with 11 different topologies.
...
\begin{figure}
	\centering\includegraphics[width=\linewidth]{fig/dynbenchmark/snote1fig_11.pdf}
	\caption{
...
\begin{figure}
	\centering\includegraphics[width=0.8\linewidth]{fig/dynbenchmark/snote1fig_12.pdf}
	\caption{
...
\begin{figure}
	\centering\includegraphics[width=0.8\linewidth]{fig/dynbenchmark/snote1fig_13.pdf}
	\caption{
